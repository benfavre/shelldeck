...
| SDTEST-1753 | `workspace_review_tests.rs::sdtest_1753_only_registered_unexpired_previews_can_submit` | SDUC-492 | Green | Provider authority cannot prepare repository work; a modified/deserialized preview and an expired registered preview cannot cross durable submit admission. Grant minting remains crate-private. |
| SDTEST-1754 | `workspace_review_tests.rs::sdtest_1754_dispatched_ledger_recovers_only_by_original_receipt` | SDUC-492 | Yellow | Drop/reload turns a durably dispatched operation into reconciliation-only work with the original key and exact receipt fences. Forced process termination plus the real receipt adapter remains SDTEST-1758. |
| SDTEST-1755 | `workspace_review_tests.rs::sdtest_1755_attention_read_state_replays_and_duplicate_coordinates_fail_closed` | SDUC-493 | Yellow | Core local-read state survives an unchanged authoritative replay and duplicate pane/session coordinates fail closed. Retained GPUI entity/deep-link integration remains SDTEST-1758. |
| SDTEST-1756 | `workspace_review_tests.rs::sdtest_1756_delivery_mutations_require_exact_fresh_projection_revision` | SDUC-492, SDUC-493 | Green | Merge submission and its receipt require the exact fresh delivery projection, target and authority revision; advanced or stale evidence is refused. |
...
| SDTEST-1758 | Release-runner + adapter + retained-GPUI integration | SDUC-492, SDUC-493 | Red | Exercise native multiprocess draft locking, forced termination between durable dispatch and response, real receipt lookup without replay, actual bounded image decoding, and exact retained-pane focus. |
