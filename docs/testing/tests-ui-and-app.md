...
| SDTEST-1812 | `tray::tests::sdtest_1812_windows_tray_asset_is_a_decodable_ico` | SDUC-434, SDUC-435 | Green | The portable Linux application suite keeps a general image-decoder smoke test for ShellDeck's complete multi-size ICO; native Windows custody is covered by SDTEST-1813..1815 below. |
