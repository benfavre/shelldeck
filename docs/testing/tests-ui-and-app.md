...
| SDTEST-1704 | `agent_console_view::tests::sdtest_1704_agent_controls_use_scale_aware_explicit_rows` | SDUC-475 | Green | The 720/960 logical-pixel breakpoints select narrow, compact, and wide control rows at both 1× and 2× UI scale; the controls cannot fall back to intrinsic flex wrapping that orphaned Model or clipped it off-screen. |
