...
| SDTEST-1553 | `companion_desktop.rs::dynamic_physics_refresh_tracks_full_visible_window_set_on_cadence` | SDUC-448, SDUC-449, SDUC-451 | Green | Dynamic falls refresh the full current visible-window set at a bounded cadence, track moved tops, discover new platforms, and remove closed windows before collision. |
