...
| SDTEST-1728 | `workspace::user_home::tests::user_account_header_breakpoint_tracks_ui_scale` | SDUC-440 | Green | L’en-tête du compte passe en colonne à 600 px logiques ou moins, reste horizontal à 700 px et suit le facteur d’échelle de l’interface. Validation X11 à 600, 700, 1081 et 1210 px : nom, rôle, e-mail et deux actions restent lisibles sans glyphe vertical ni débordement. |
