...
| SDTEST-1726 | `i18n::tests::locale_fr_and_en` | SDUC-484 | Green | Les timestamps de compte RFC 3339 deviennent aujourd’hui/hier/date dans le fuseau local, avec ordre de date français ou anglais ; une ancienne valeur non RFC 3339 reste lisible au lieu de disparaître. |
