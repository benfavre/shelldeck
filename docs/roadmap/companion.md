...
| Personnage desktop autonome | Snap magnétique DPI-aware, suivi par ID stable, work areas par écran sur Windows/macOS et EWMH root sur X11, reduced motion OS et physique AABB déterministe livrés | SDUC-445..451, SDTEST-1460..1573 |
