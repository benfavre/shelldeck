...
| REL-003 | NEXT-005 | SSH session/pool/tunnels | Les chemins critiques dépendent encore de vrais transports ou de sockets difficiles à piloter. | P0 | Ouvert | Concevoir `FakeTransport`/fake connector puis reprendre SDTEST-520/521/524/528, 540..544 et 562/564/566 sans réseau réel. |
