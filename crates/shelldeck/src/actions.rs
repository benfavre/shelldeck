...
pub use shelldeck_ui::workspace::{
    CloseTab, CloudSyncNow, JeanTogglePause, NewTerminal, NextTab, OpenFileEditorView, OpenFleet,
    OpenJeanConsole, OpenQuickConnect, OpenSettings, PrevTab, Quit, SwitchSite, ToggleJeanRuntime,
    ToggleSidebar,
};
