...
mod tests {
    ...
    /// Every slide the tour can show. SDTEST-1698 keeps this honest against
    /// the enum.
    ...
    #[test]
    fn sdtest_1695_the_run_follows_the_mode_and_the_modes_slide_follows_capability() {
    ...
    #[test]
    fn sdtest_1696_every_slide_resolves_its_copy() {
    ...
    #[test]
    fn sdtest_1697_every_slide_asset_is_embedded_and_listed() {
    ...
    #[test]
    fn sdtest_1698_runs_cover_every_slide() {
