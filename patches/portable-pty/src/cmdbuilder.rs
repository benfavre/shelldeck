...
impl CommandBuilder {
    ...
    pub(crate) fn current_directory(&self) -> Option<Vec<u16>> {
        ...
        // An explicit cwd is an authority boundary, not a hint. Passing it to
        // CreateProcessW even if it disappeared after the caller validated it
        // makes process creation fail closed. Falling back to USERPROFILE here
        // would launch a shell outside the authorized workspace.
