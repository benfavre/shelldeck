...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .flow-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:12px;background:#edf4ff;color:var(--blue)}.flow-icon svg{display:block;width:19px;height:19px}
    .flow-step b{display:block;font-size:14px}.flow-copy>span{display:block;margin-top:3px;color:#7b8490;font-size:12px}.flow-arrow{color:#9aa7b8}
  ...
  <main id="top">
    ...
    <section class="inklura-section" id="inklura">
      <div class="shell inklura-panel"><div class="inklura-copy"><p class="overline">Relié à votre environnement</p><h2>Le même fil, jusqu’à la résolution.</h2><p>Sites, demandes et accès restent reliés à Inklura Manage. Automonique apporte l’exécution souveraine, Monique réalise le travail et ShellDeck garde la supervision au même endroit.</p><div class="inklura-actions"><a class="button button-primary" href="#telecharger">Utiliser ShellDeck</a><a class="button button-secondary" href="https://www.automonique.fr" target="_blank" rel="noopener">Voir Automonique <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M15 4h5v5M20 4l-9 9"/><path d="M18 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h6"/></svg></a></div></div>
        <div class="flow-card"><div class="flow-step"><span class="flow-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M20 13c0 5-3.5 7-8 7a9 9 0 0 1-4-.9L3 21l1.8-4A8 8 0 1 1 20 13Z"/></svg></span><span class="flow-copy"><b>Utilisateur</b><span>Crée et suit sa demande</span></span><span class="flow-arrow">→</span></div><div class="flow-step"><span class="flow-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M4 4h16v16H4zM4 9h16M9 9v11"/></svg></span><span class="flow-copy"><b>Support</b><span>Qualifie, répond et coordonne</span></span><span class="flow-arrow">→</span></div><div class="flow-step"><span class="flow-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="4"/></svg></span><span class="flow-copy"><b>Dev</b><span>Diagnostique et intervient</span></span><span class="flow-arrow">✓</span></div></div>
      </div>
    </section>
